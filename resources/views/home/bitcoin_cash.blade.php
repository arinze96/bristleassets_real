...
<head>
    ...
    <title>Your easy guide to mining Bitcoin Cash</title>
            ...
            <div class="counter-wrapper wow fadeIn" data-wow-delay="0.2s">
                <div class="row  my-auto ">
                    <div class="col-md-12 col-lg-12 counter-items">
                        ...
                        <h1 style="color: white">Your easy guide to mining Bitcoin Cash</h1>
                    </div>
                </div>
                <!--row-->
            </div>
                ...
                <div class="container">
                    <div class="tradingview-widget-container" style="margin:auto;">
                        <p>
                            ...
                            basically the process of finding the answers to difficult cryptography puzzles.
                        </p>

                        <p>
                            In the cryptocurrency world mining is necessary because solving these puzzles ensure that
                            cryptocurrency transactions are ticked off as legitimate. It also ensures that the supply of
                            a cryptocurrency like Bitcoin Cash grows as mining adds new coins into circulation.
                        </p>

                        <p>
                            However mining requires a lot of computing power – and patience – so miners are rewarded for
                            their efforts. At the moment Bitcoin Cash miners get 12.5 BCH for every block that they can
                            validate. They also get all of the transaction fees for that block as validate it.
                        </p>

                        <h3>
                            Can you make money mining Bitcoin Cash?
                        </h3>
                        ...
                        <h3>
                            Comparing mining Bitcoin to mining Bitcoin Cash
                        </h3>
                        ...
                        <h3>
                            What you need to get started mining Bitcoin Cash
                        </h3>
                        ...
                        <h3>
                            Should you mine in a pool?
                        </h3>

                        <p>The next step is a very important choice: do you want to mine on your own, or do you want to join a pool of Bitcoin Cash miners?</p>
                        ...
                        <br>
                        <p>Some of the most popular Bitcoin Cash mining pools include:</p>
                        <br>
                        <ul>
                            <li>F2Pool</li>
                            <br>
                        ...
                        <p>
                            In most cases mining pools will have custom software that you use for mining, this software could even be pre-configured: also containing a wallet address. All yo
                            u need to do is plug your rig into the electricity grid and that’s it.
                        </p>
                        ...
                        <h3>What are your hardware options?</h3>
                        ...
                        <h3>What are your software options?</h3>
                        ...
                        <p>
                            For a comprehensive list of cloud mining services check out CryptoCompare as it provides a nice comparison service which can help you find which crypto mining contracts provide good investments. One of the most popular cloud mining services is Bristle Assets.
                        </p>
                    </div>
