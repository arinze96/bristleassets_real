            ...
            <div class="counter-wrapper wow fadeIn" data-wow-delay="0.2s">
                <div class="row  my-auto ">
                    <div class="col-md-12 col-lg-12 counter-items">
                        ...
                        <h1 style="color: white">Why mining Ripple isn't possible</h1>
                    </div>
                </div>
                <!--row-->
            </div>
            ...
            <div class="row wow fadeIn" data-wow-delay="0.2s">
                ...
                <div class="container">
                    <div class="tradingview-widget-container" style="margin:auto;">
                        ...
                        <ol>
                            <li>
                                Mining implies getting rewarded by newly released coins, in other words, mining creates new coins. Well, all of the Ripple coins that will ever exist has already been released – the full stock of Ripple coins is already out there.
                            </li>
                            <br>
                            <li>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem odit non odio accusantium cum totam nostrum. Vitae amet doloribus iste similique dignissimos, sapiente qui quidem a beatae, eveniet sed odio.
                            ...
                            <br>
                            <li>
                                Decentralisation is a core tenet of all cryptocurrencies, but Ripple has tweaked the decentralisation principle. Yes, for Ripple, third-party nodes are involved in validation and authorisation of blockchain transactions, but overall Ripple Labs remains in charge of the workings of the XRP blockchain.
                            </li>
                        </ol>
