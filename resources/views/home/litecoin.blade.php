            ...
            <div class="counter-wrapper wow fadeIn" data-wow-delay="0.2s">
                <div class="row  my-auto ">
                    <div class="col-md-12 col-lg-12 counter-items">
                        ...
                        <h1 style="color: white">Everything you need to know about mining Litecoin</h1>
                    </div>
                </div>
                <!--row-->
            </div>
        ...
        <div class="container">
            <div class="row wow fadeIn" data-wow-delay="0.2s">
                ...
                <div class="container">
                    ...
                    <h3>
                        Mining Litecoin has become very popular
                    </h3>
