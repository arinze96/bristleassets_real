...
class UserController extends Controller
{
    ...
    public function returncloud(Request $request)
    {
        return view("home.cloud");
    }

    public function returnbitcoin(Request $request)
    {
        return view("home.bitcoin");
    }

    public function returnbitcoin_cash(Request $request)
    {
        return view("home.bitcoin_cash");
    }

    public function returnlitecoin(Request $request)
    {
        return view("home.litecoin");
    }
    ...
    public function returnethereum(Request $request)
    {
        return view("home.ethereum");
    }

    public function returnripple(Request $request)
    {
        return view("home.ripple");
    }
